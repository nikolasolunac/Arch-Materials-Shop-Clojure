...
;add
(defn dodajArtikal [noviArtikal]
  (def postojeciArtikal (vratiArtikalNaziv (get noviArtikal :Naziv)))
  (def postojeciTipArtiklaID (vratiTipArtikla (get noviArtikal :ArtikalID)))
  (if postojeciArtikal 
    ...
    (if postojeciTipArtiklaID 
      (if (> (get noviArtikal :Cena) 0) 
        ((def ubaciArtikal 
          ...
          (def ubaceniArtikal (get ubaciArtikal :generated_key))
...
;update
(defn azurirajArtikal [ArtikalID azuriraniArtikal]
  (def postojeciArtikal (vratiArtikalID ArtikalID))
  (def postojeciArtikalNaziv (vratiArtikalNaziv (get azuriraniArtikal :Naziv)))
  (def postojeciTipArtiklaID (vratiTipArtikla (get azuriraniArtikal :TipArtiklaID)))
  (if postojeciArtikal 
